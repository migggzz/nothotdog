...
var modelFile = 'models/model.tflite';  // name of model neural network
var labelsFile = 'models/labels.txt'; // labels of the neural network
        ...
        return(
            <LinearGradient colors={['#dd3e54','#dd3e09']} style={styles.linearGradient}>
                <View style={styles.titleContainer}>
                    ...
                    <Text style={styles.subtitle}>First React / AI App for Miggz</Text>
                </View>
                <View style={styles.outputContainer}>
                    {
                        recognitions ? <View><Image source={source} style={styles.hotdogImage}></Image>
                        <Text 
                            style={{
                                color: 'white', 
                                textAlign: 'center', 
